    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9" data-aos="fade-up">
                <h3 class="category-title">{{$blog->catagory->catagory_name}}</h3>

                <div class="d-md-flex post-entry-2 half">
                    <a href="{{route('blog.details',['slug'=>$blog->slug, 'id'=>$blog->id])}}" class="me-4 thumbnail">
                        <img src="{{asset($blog->image)}}" alt="" class="img-fluid">
                    </a>
                    <div>
                        <div class="post-meta"><span class="date">Culture</span> <span class="mx-1">&bullet;</span> <span>{{ $blog->created_at}}</span></div>
